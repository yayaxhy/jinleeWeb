...
export async function GET() {
  try {
    ...
    return new Response(`Failed to load /newhome/404: ${message}. Run "npm run newhome:vendor" or rebuild the app so the vendored files are generated under public/newhome.`, {
      status: 500,
      headers: {
