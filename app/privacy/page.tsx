...
export const metadata: Metadata = {
  title: '隐私政策｜点了么娱乐公会',
  description: '点了么娱乐公会收集、使用、保存和保护个人信息的规则。',
...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          本政策适用于您访问点了么娱乐公会网站，以及使用账户、充值、陪玩需求、订单和售后等相关功能的过程。个人信息处理者为
  ...
  },
  {
    ...
    content: (
      <>
        <ul>
          <li><strong>账户与身份信息：</strong>会员账户标识，以及您通过 Discord 或微信授权提供的用户标识、昵称、头像和绑定状态。</li>
