    ...
    <section className="relative mx-auto max-w-7xl px-6 pb-8 pt-2 md:pb-12">
      <div className="relative isolate overflow-hidden rounded-[2.5rem] border border-[#ffb8cc]/70 bg-[#fff6f1] px-6 py-8 text-[#563b4d] shadow-[0_25px_70px_rgba(255,128,159,0.2)] md:px-10 md:py-10">
        ...
        <Image
          ...
          width={200}
          height={200}
          className="pointer-events-none absolute -bottom-10 left-[38%] hidden w-28 -rotate-12 drop-shadow-[0_12px_14px_rgba(180,77,112,0.2)] md:block"
        />
        <div className="relative grid items-center gap-8 md:grid-cols-[1fr_0.92fr]">
          <div className="max-w-xl">
            ...
            <p className="mt-4 max-w-lg text-sm leading-7 text-[#896577] md:text-base">
              每天领券、每周攒福利，新用户完成两单还有额外惊喜。可领取资格和券的到期日，都能在福利页与背包里查看。
            </p>
            <div className="mt-6 flex flex-wrap gap-2 text-xs font-bold text-[#86445e]">
              <span className="rounded-full bg-white px-3 py-2 shadow-sm">每日特殊 9 折券</span>
              <span className="rounded-full bg-white px-3 py-2 shadow-sm">满 ¥1,000 领日冠 75 折</span>
              <span className="rounded-full bg-white px-3 py-2 shadow-sm">新用户 2 单加赠</span>
            </div>
            <Link
          ...
          <div className="relative mx-auto h-[260px] w-full max-w-[450px] sm:h-[290px]">
            ...
            />
            <span className="absolute right-4 top-2 grid h-14 w-14 place-items-center rounded-full border-2 border-white bg-[#ff8eaa] text-2xl shadow-lg">✦</span>
          </div>
        </div>
      </div>
    </section>
