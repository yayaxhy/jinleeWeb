...
const DISCORD_BIND_TOKEN_TTL_MS = 1000 * 60 * 10;
...
const encodeToken = (payload: DiscordBindTokenPayload) => {
...
export const verifyDiscordBindToken = (token?: string | null): DiscordBindTokenPayload | null => {
