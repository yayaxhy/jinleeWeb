export const VIP_LEVELS = [
  { vipLevel: 1, threshold: 500, name: '小班' },
  { vipLevel: 2, threshold: 1500, name: '中班' },
  { vipLevel: 3, threshold: 3000, name: '大班' },
  { vipLevel: 4, threshold: 5000, name: '一年级' },
  { vipLevel: 5, threshold: 10000, name: '二年级' },
  { vipLevel: 6, threshold: 20000, name: '三年级' },
  { vipLevel: 7, threshold: 50000, name: '四年级' },
  { vipLevel: 8, threshold: 120000, name: '五年级' },
  { vipLevel: 9, threshold: 210000, name: '六年级' },
  { vipLevel: 10, threshold: 340000, name: '初中生' },
  { vipLevel: 11, threshold: 520000, name: '高中生' },
  { vipLevel: 12, threshold: 880000, name: '大学生' },
] as const;
